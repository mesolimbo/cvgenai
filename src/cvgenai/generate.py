...
class DocumentGenerator(IDocumentGenerator):
    ...
    def generate(self, args: Namespace) -> Dict[str, Any]:
        ...
        #
        # def generate_tailored_documents(base_resume_md, job_description):
        #     prompt = f"""
        ...
        #     resume_md = content.split("RESUME:")[1].split("COVER LETTER:")[0].strip()
        #     cover_md = content.split("COVER LETTER:")[1].strip()
        #     return resume_md, cover_md
        #
        # ... Prompt generated by subclass, called by shared API method, response parse by subclass then returned
        # as elements
